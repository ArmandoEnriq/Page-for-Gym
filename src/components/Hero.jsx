  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4 max-w-screen-xl mx-auto">
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white tracking-tighter mb-4 drop-shadow-lg font-oswald text-shadow-blue">
          STRONGFIT STUDIO
        </h1>
        <p className="text-lg md:text-2xl text-yellow-600 font-bold tracking-[0.2em] uppercase mb-8 drop-shadow-md animate-pulse font-oswald">
          Inscribete Ahora
        </p>
