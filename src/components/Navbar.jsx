...
const Navbar = () => {
    ...
    const navLinks = [
        { name: 'INICIO', href: '#' },
        { name: 'INSTALACIONES', href: '#topics' },
        { name: 'TRÁILER', href: '#trailer' },
        { name: 'MÁS INFORMACIÓN', href: '#about' },
        { name: 'PROTAGONISTA', href: '#character' },
        { name: 'UBICACIÓN', href: '#location' },
        { name: 'EL JUEGO', href: '#gameplay' },
        { name: 'DLC', href: '#dlc' },
    ];
        ...
        <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black/90 backdrop-blur-sm py-2' : 'bg-transparent py-6'}`}>
            <div className="container mx-auto px-4 flex justify-between items-center">
                <div className="flex items-center space-x-8">
                    <a href="#" className="text-3xl font-bold text-white tracking-tighter hover:text-yellow-400 transition-colors font-oswald">
                        SFit
                    </a>
